...
every parsed DACL entry to be an allow entry for only the current user SID. CodeScope uses
...
permission check; disappearance or replacement after reading is rejected. CodeScope does not
