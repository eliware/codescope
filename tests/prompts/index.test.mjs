...
test('builds strict tools with complete category sets', () => {
  ...
  expect(Object.keys(createReviewTool().parameters.properties.issues.properties)).toEqual(
    REVIEW_CATEGORIES,
  );
  expect(Object.keys(createSuggestionTool().parameters.properties.suggestions.properties)).toEqual(
    SUGGESTION_CATEGORIES,
  );
});
