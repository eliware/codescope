...
test('extracts categories from the active tool schema', () => {
  expect(toolCategories({ parameters: { properties: { issues: { properties: { correctness: {}, security: {} } } } } })).toEqual(['correctness', 'security']);
